git remote add GabovES https://github.com/GabovYegor/AiSD
git remote add AndersonGH https://github.com/AndersonGH/AiSD
git remote add GlazunovSA https://github.com/light5551/AiSD
